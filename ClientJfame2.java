...
public class ClientJfame2 extends JFrame {

	private JPanel contentPane;
	private JTextField ClienttextField;
	private JTextArea ClienttextArea;
	private ClientJfame2 clientjfame;
	private PrintWriter os;
	
	public static void main(String[] args) throws Exception {
		 new ClientJfame2(5002,"127.0.0.2");		
	}
	 ...
	 * @throws Exception 
	 */
	public ClientJfame2(int port,String addr) throws Exception {
	...
	protected void actionperformedClient(ActionEvent e) {
		...
		this.ClienttextArea.append("客户端2："+ClienttextField.getText()+"\n");
